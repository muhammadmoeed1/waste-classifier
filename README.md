...
**Overall validation accuracy: 82.0%**

| Class      | Precision | Recall | F1   | Support |
|------------|-----------|--------|------|---------|
| cardboard  | 0.90      | 0.90   | 0.90 | 83      |
| glass      | 0.84      | 0.74   | 0.79 | 103     |
| metal      | 0.86      | 0.87   | 0.87 | 78      |
| paper      | 0.90      | 0.84   | 0.87 | 124     |
| plastic    | 0.68      | 0.85   | 0.76 | 88      |
| trash      | 0.59      | 0.55   | 0.57 | 29      |
...
The confusion matrix shows the model's main weakness is the **glass ↔ plastic**
boundary (transparent containers look alike) and the small, under-represented
**trash** class (only ~137 images total) — both realistic, well-understood
failure modes rather than random error, and natural targets for future
improvement (class balancing / more data).
